...
public class Admin_Register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(670, 80));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        SuperAdminDashboard spad = new SuperAdminDashboard();
        this.dispose();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (fname.isEmpty()) {
            ...
            try {
                ResultSet resultSet = com.Mysql.execute("INSERT INTO `admin`(`fname`,`lname`,`email`,`password`,`mobile`,`address`,`gender_g_id`,`status_st_id`) "
                        + "VALUES('" + fname + "','" + lname + "','" + email + "','" + password + "','" + mobile + "','" + address + "','" + GenMap.get(gender) + "','1');");
                
                JOptionPane.showMessageDialog(this, "Admin Registration Sucessful", "Sucess", JOptionPane.INFORMATION_MESSAGE);
                reset();
            } catch (Exception e) {
                e.printStackTrace();
            }
